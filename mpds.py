...
diabetes_model = pickle.load(open(r'C:\Users\sarav\OneDrive\Documents\mpds\saved models/diabetes_model.sav', 'rb'))

heart_disease_model = pickle.load(open(r'C:\Users\sarav\OneDrive\Documents\mpds\saved models/heart_disease_model.sav', 'rb'))

parkinsons_model = pickle.load(open(r'C:\Users\sarav\OneDrive\Documents\mpds\saved models/parkinsons_model.sav', 'rb'))
